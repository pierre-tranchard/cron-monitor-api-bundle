    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
                 ...
                 ->scalarNode('user_provider')
                     ->info('The user provider service that implements Tranchard\\CronMonitorApiBundle\\Security\\UserProviderInterface')
                     ->cannotBeEmpty()
                 ->end()
                 ->scalarNode('notification_system')
                     ->info('The notification system Tranchard\\CronMonitorApiBundle\\Notification\\NotificationSystemInterface')
                     ->cannotBeEmpty()
                 ->end()
